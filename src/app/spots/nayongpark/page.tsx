// src/app/spots/nayong-park/page.tsx
"use client";
  ...
  return (
    <main className="min-h-screen bg-gray-100 text-gray-800 font-sans">
      ...
      <section className="relative h-[600px] w-full overflow-hidden">
        <Image
          src="https://mxatayqbwx.ufs.sh/f/PwsLPXIQSutRK1Re31X8kLTRVqaJOEfSBZHY4QvGhy92Uw5z" // Replace with your hero image
      ...
      <section id="details" className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <Image
              src="https://mxatayqbwx.ufs.sh/f/PwsLPXIQSutRnFyIbAvIk5pOnFGovmXjSa8twVUilb0WEPz7" // Replace with a landscape image
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">
              Explore replicas of traditional Filipino houses from various
              regions.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Museums</h3>
            <p className="text-gray-600">
              Visit museums showcasing Philippine currency, textiles, and
              culture.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">
              Enjoy traditional Filipino dances and music.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-2 text-gray-900">
            ...
            <p className="text-gray-600">
              See replicas of significant historical sites.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-2 text-gray-900">
            ...
            <p className="text-gray-600">
              Learn about the cultures of various indigenous groups.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-600">
          ...
          Contact information and updated details about opening hours and
          events can be found on their official website or social media pages.
        </p>
      </section>
    </main>
  );
